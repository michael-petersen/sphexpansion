...
compile string: 
clang++ -I/opt/local/include -L/opt/local/lib -Iinclude/ speed.cc -o speed
			      ...
			      double& fx, double& fy, double& fz, bool verbose)
{
  ...
  MW->determine_fields_at_point_sph(mwcoefs,rtmp,thetatmp,phitmp,
				    tpotl0,tpotl,
				    fr,ft,fp);
...
int main () {
  ...
  for (int xx=0; xx<100; xx++) {
    ...
    */
    ...
    // 1:25 for 100k in this iteration
