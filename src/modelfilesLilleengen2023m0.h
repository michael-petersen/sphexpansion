...
MSP 14 Mar 2023 upload the m=0 disc-limited version of Lilleengen et al. (2023)
...
string coef_file_mw        = model_datadir+"simpleoutcoef.nfac.compare.mw."+runtagb;
...
string cyl_coef_name_mw    = model_datadir+"simpleoutcoef.nfac.compare.disc."+runtagb;
...
string coef_file_lmc       = model_datadir+"simpleoutcoef.nfac.compare.lmc."+runtagb;
